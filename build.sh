...
cp -rv brave-bin/* CustomRepo/
cp -rv cfiles/* CustomRepo/
cp -rv dmenu/* CustomRepo/
cp -rv dwm/* CustomRepo/
cp -rv dwmblocks/* CustomRepo/
cp -rv paru/* CustomRepo/
cp -rv st/* CustomRepo/
cp -rv vim-plug/* CustomRepo/
cp -rv libxft-bgra/* CustomRepo/
